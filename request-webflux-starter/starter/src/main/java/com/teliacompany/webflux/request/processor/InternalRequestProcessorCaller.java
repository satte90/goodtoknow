...
public final class InternalRequestProcessorCaller {
    private final InternalRequestProcessor requestProcessor;
    private final ServerHttpRequest serverHttpRequest;
    private RequestLoggingOptions requestLoggingOptions = RequestLoggingOptions.defaults().disableLogging();

    InternalRequestProcessorCaller(InternalRequestProcessor requestProcessor, ServerHttpRequest serverHttpRequest) {
     ...
     */
    public WithoutRequest withoutRequestObject() {
     ...
     */
    public <O> Mono<O> withHandler(Supplier<Mono<O>> supplier) {
        return withoutRequestObject().withHandler(supplier);
    }
    ...
    public class WithBiRequest<I, J, IC> {
         ...
         */
        public <O> Mono<O> withHandler(BiFunction<IC, J, Mono<O>> handler) {
            RequestHandler<I, J, IC, O, O> rh = new RequestHandler<>(handler, inputConverter, o -> o);
            return requestProcessor.processInternal(serverHttpRequest, requestBody, rh, transactionMetaDataProducer, requestLoggingOptions);
        }
        ...
        public class WithBiRequestAndOutputConverter<O, OC> {
             ...
             * Set handler function, build and execute! Use this when you expect two input arguments
             */
            public Mono<OC> withHandler(BiFunction<IC, J, Mono<O>> handler) {
    ...
    public class WithRequest<I, J, IC> {
         ...
         */
        public <O> Mono<O> withHandler(Function<IC, Mono<O>> handler) {
            RequestHandler<I, J, IC, O, O> rh = new RequestHandler<>(handler, inputConverter, o -> o);
            return requestProcessor.processInternal(serverHttpRequest, requestBody, rh, transactionMetaDataProducer, requestLoggingOptions);
        }
        ...
        public class WithRequestAndOutputConverter<O, OC> {
             ...
             * Set handler function, build and execute! Use this when you expect one input argument
             */
            public Mono<OC> withHandler(Function<IC, Mono<O>> handler) {
                RequestHandler<I, J, IC, O, OC> rh = new RequestHandler<>(handler, inputConverter, outputConverter);
                return requestProcessor.processInternal(serverHttpRequest, requestBody, rh, transactionMetaDataProducer, requestLoggingOptions);
            }
        }
    ...
    public class WithoutRequest {
        ...
        public class WithoutRequestAndOutputConverter<O, OC> {
             ...
             * Set handler function, build and execute! Use this when you don't need any input for the handler function
             */
            public Mono<OC> withHandler(Supplier<Mono<O>> supplier) {
